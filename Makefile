...
#    Updated: 2022/08/09 22:14:37 by mvavasso         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= ft_bzero.c ft_toupper.c ft_tolower.c ft_substr.c ft_isdigit.c ft_isascii.c ft_isalpha.c ft_isalnum.c ft_calloc.c\
			...
			ft_split.c ft_putchar.c ft_free.c ft_putnbrbase.c get_next_line.c ft_converthex.c ft_convertu.c ft_convertint.c \
			ft_convertptr.c ft_printf.c
